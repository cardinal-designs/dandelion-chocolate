...
class PredictiveSearch {
  constructor(container) {
    ...
    // this.mobileform = document.querySelector('form.searchform-mobile');
    // this.mobileappenddata = document.querySelector('.side-panel-content--has-tabs-mobile');
    // this.inputMobile = this.mobileform.querySelector('input[type="search"]');
  ...
  renderSearchResults(resultsMarkup) {
    ...
    let _this = this,
      submitButton = this.container.querySelector('#search-results-submit-button'),
      submitButtonMobile = this.container.querySelector('#search-results-submit');
...
window.addEventListener('load', () => {
  if (typeof PredictiveSearch !== 'undefined') {
    new PredictiveSearch(document.getElementById('mobile-drawer-search'));
    new PredictiveSearch(document.getElementById('Search-Drawer'));
  }
});