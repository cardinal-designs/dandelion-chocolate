if (!customElements.get('variant-selects')) {
  ...
  class VariantSelects extends HTMLElement {
    ...
    getSectionsToRender() {
      return [`price-${this.dataset.section}`, `price-${this.dataset.section}--sticky`, `price-btn-${this.dataset.section}--sticky`, `product-image-${this.dataset.section}--sticky`, `inventory-${this.dataset.section}`, `sku-${this.dataset.section}`, `quantity-${this.dataset.section}`];
    }
...
if (!customElements.get('product-form')) {
  customElements.define('product-form', class ProductForm extends HTMLElement {
    ...
    onSubmitHandler(evt) {
      evt.preventDefault();
      const submitButtons = this.querySelectorAll('.single-add-to-cart-button');
  ...
  class ProductAddToCartSticky extends HTMLElement {
    ...
    setupObservers() {
      let _this = this,
        ...
        form = document.getElementById(`sticky-product-form-${this.dataset.section}`),
